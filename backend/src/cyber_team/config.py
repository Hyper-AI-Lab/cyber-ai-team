...
class Settings(BaseSettings):
    ...
    operating_model_max_domains: int = 25
    operating_model_reconciliation_enabled: bool = True
    operating_model_reconciliation_interval_seconds: int = 900
    operating_model_min_confidence: float = 0.72
    operating_model_shadow_successes: int = 3
    operating_model_shadow_min_duration_seconds: int = 3600
    operating_model_retirement_grace_days: int = 7
    operating_model_retirement_absent_revisions: int = 3
    operating_model_auto_apply_low_risk: bool = True
    operating_model_policy_cases_per_cycle: int = 2
    discovery_obligation_max_attempts: int = 3
    discovery_obligation_retry_base_seconds: int = 300
    ...
    outcome_assessment_batch_size: int = 200
    outcome_readiness_stale_after_seconds: int = 1800
    ...
    integration_status_validation_timeout_seconds: float = 12.0
